...
public class Retailer implements ActionListener{
    ...
    private JLabel lJudul, lNamaRetailer, lAlamat, lAtau, labelDummy, labelDummy2, labelDummy3;
    private JTextField tfNamaRetailer, tfAlamat;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getActionCommand() == "tambah"){
            ...
            try {
                //ds ini objek DatabaseService nya, udah di definisiin diatas
                String hasil = ds.tambahRetailer(nama, alamat);
